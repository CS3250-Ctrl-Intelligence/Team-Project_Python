...
class MainWindow(QtWidgets.QMainWindow):
    '''This class implements main window, displays window/info for allOrders'''
    def __init__(self, *args, **kwargs):
        super(MainWindow, self).__init__(*args, **kwargs)

        self.graphWidget = pg.PlotWidget()
        self.setCentralWidget(self.graphWidget)
        amount = Database_Functions.getAllOrders()
        r = range(len(amount))
        date = [*r]
        ...
        self.graphWidget.setTitle("# of Orders by week (All-Time)", color="w", size="25pt")
