# Form implementation generated from reading ui file 'c:\Users\Marin\Documents\Team-Project_Python\backend_files\orders.ui'
#
...
"background-color:  #16191d;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_username.setText(_translate("Dialog", "Orders"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Dialog", "Date"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "Customer Email"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "Customer Location"))
