# Form implementation generated from reading ui file 'c:\Users\Marin\Documents\Team-Project_Python\backend_files\ui_files\home.ui'
#
...
"")
        ...
        self.label_username.setGeometry(QtCore.QRect(10, 10, 341, 51))
        font = QtGui.QFont()
        ...
        self.label_password.setGeometry(QtCore.QRect(40, 80, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_password.setFont(font)
        self.label_password.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_password.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_password.setObjectName("label_password")
        self.label_password_3 = QtWidgets.QLabel(self.mainWindow)
        self.label_password_3.setGeometry(QtCore.QRect(40, 110, 281, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_password_3.setFont(font)
        self.label_password_3.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_password_3.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_password_3.setObjectName("label_password_3")
        self.label_password_4 = QtWidgets.QLabel(self.mainWindow)
        self.label_password_4.setGeometry(QtCore.QRect(40, 140, 481, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_password_4.setFont(font)
        self.label_password_4.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_password_4.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_password_4.setObjectName("label_password_4")
        self.label_password_5 = QtWidgets.QLabel(self.mainWindow)
        self.label_password_5.setGeometry(QtCore.QRect(40, 170, 431, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_password_5.setFont(font)
        self.label_password_5.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_password_5.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_password_5.setObjectName("label_password_5")
        self.label_password_6 = QtWidgets.QLabel(self.mainWindow)
        self.label_password_6.setGeometry(QtCore.QRect(40, 200, 401, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_password_6.setFont(font)
        self.label_password_6.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_password_6.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
...
"background-color:  #16191d;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_username.setText(_translate("Dialog", "Daily Reminders"))
        self.label_password.setText(_translate("Dialog", "-Don\'t forget to review all inventory."))
        self.label_password_3.setText(_translate("Dialog", "-Make sure to ship all of the new orders."))
        self.label_password_4.setText(_translate("Dialog", "-Go over the reports. (See supervisor if you don\'t understand them)"))
        self.label_password_5.setText(_translate("Dialog", "-Remeber your training and ask questions whenever needed."))
        self.label_password_6.setText(_translate("Dialog", "-Don\'t forget to close the application when you are done."))
