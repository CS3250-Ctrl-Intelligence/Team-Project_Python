# Form implementation generated from reading ui file 'c:\Users\Marin\Documents\Team-Project_Python\backend_files\ui_files\market.ui'
#
...
"")
        ...
        self.monthlyBtn = QtWidgets.QPushButton(self.mainWindow)
        self.monthlyBtn.setGeometry(QtCore.QRect(20, 190, 91, 31))
        self.monthlyBtn.setStyleSheet("background-color: rgb(255, 85, 0);\n"
"border-radius: 10px;")
        self.monthlyBtn.setObjectName("monthlyBtn")
        self.weeklyBtn = QtWidgets.QPushButton(self.mainWindow)
        self.weeklyBtn.setGeometry(QtCore.QRect(20, 140, 91, 31))
        self.weeklyBtn.setStyleSheet("background-color: rgb(255, 85, 0);\n"
"border-radius: 10px;")
        self.weeklyBtn.setObjectName("weeklyBtn")
        self.dailyBtn = QtWidgets.QPushButton(self.mainWindow)
        self.dailyBtn.setGeometry(QtCore.QRect(20, 90, 91, 31))
        self.dailyBtn.setStyleSheet("background-color: rgb(255, 85, 0);\n"
"border-radius: 10px;")
        self.dailyBtn.setObjectName("dailyBtn")
        self.lineDate = QtWidgets.QLineEdit(self.mainWindow)
        self.lineDate.setGeometry(QtCore.QRect(420, 90, 161, 31))
        ...
        self.label_2.setGeometry(QtCore.QRect(160, 90, 251, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_2.setFont(font)
        self.label_2.setStyleSheet("color: rgb(255, 255, 255);")
        self.label_2.setObjectName("label_2")
        self.lineProduct = QtWidgets.QLineEdit(self.mainWindow)
        self.lineProduct.setGeometry(QtCore.QRect(460, 190, 241, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineProduct.setFont(font)
        self.lineProduct.setStyleSheet("border: no border;\n"
"color: rgb(255, 255, 255);")
        self.lineProduct.setObjectName("lineProduct")
        self.lineLabelP = QtWidgets.QLineEdit(self.mainWindow)
        self.lineLabelP.setGeometry(QtCore.QRect(140, 190, 291, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineLabelP.setFont(font)
        self.lineLabelP.setStyleSheet("border: no border;\n"
"color: rgb(255, 255, 255);")
        self.lineLabelP.setObjectName("lineLabelP")
        self.lineLabelC = QtWidgets.QLineEdit(self.mainWindow)
        self.lineLabelC.setGeometry(QtCore.QRect(70, 250, 311, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineLabelC.setFont(font)
        self.lineLabelC.setStyleSheet("border: no border;\n"
"color: rgb(255, 255, 255);")
        self.lineLabelC.setObjectName("lineLabelC")
        self.lineCustomer = QtWidgets.QLineEdit(self.mainWindow)
        self.lineCustomer.setGeometry(QtCore.QRect(430, 250, 271, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineCustomer.setFont(font)
        self.lineCustomer.setStyleSheet("border: no border;\n"
"color: rgb(255, 255, 255);")
        self.lineCustomer.setObjectName("lineCustomer")
...
"background-color:  #16191d;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_username.setText(_translate("Dialog", "Reports"))
        self.monthlyBtn.setText(_translate("Dialog", "Monthly"))
        self.weeklyBtn.setText(_translate("Dialog", "Weekly"))
        self.dailyBtn.setText(_translate("Dialog", "Daily"))
        self.label_2.setText(_translate("Dialog", "Please enter a date (YYYY-MM-DD):"))
